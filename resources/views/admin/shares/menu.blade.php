    ...
    <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border container-xxl" role="navigation" data-menu="menu-wrapper" data-menu-type="floating-nav">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
          <li class="nav-item mr-auto"><a class="navbar-brand" href="/assets_admin/html/ltr/horizontal-menu-template/index.html"><span class="brand-logo">
      ...
      <div class="navbar-container main-menu-content" data-menu="menu-container">
        ...
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
          <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link d-flex align-items-center" href="index.html" data-toggle="dropdown"><i data-feather="home"></i><span data-i18n="Dashboards">Quản Lý</span></a>
            <ul class="dropdown-menu">
              <li class="active" data-menu=""><a class="dropdown-item d-flex align-items-center" href="/admin/danh-muc-san-pham/index" data-toggle="dropdown" data-i18n="eCommerce"><span data-i18n="eCommerce">Quản Lý Danh Mục </span></a>
              </li>
              <li class="active" data-menu=""><a class="dropdown-item d-flex align-items-center" href="/admin/san-pham/index" data-toggle="dropdown" data-i18n="eCommerce"><span data-i18n="eCommerce">Sản Phẩm</span></a>
              </li>
              ...
              <li class="active" data-menu=""><a class="dropdown-item d-flex align-items-center" href="/admin/hoa-don/index" data-toggle="dropdown" data-i18n="eCommerce"><span data-i18n="eCommerce">Quản Lý In Bill</span></a>
              </li>
              ...
              <li class="active" data-menu=""><a class="dropdown-item d-flex align-items-center" href="/admin/doanh-thu/index" data-toggle="dropdown" data-i18n="eCommerce"><span data-i18n="eCommerce">Quản lý Hóa Đơn</span></a>
              </li>
            </ul>
          </li>
        </ul>
